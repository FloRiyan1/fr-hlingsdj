...
export const NowPlaying: React.FC<NowPlayingProps> = ({ playback, onShowVoters }) => {
  if (!playback) return (
            ...
            {playback.voterInfo && (
              ...
              >
                <div className="flex items-center gap-2 pr-3 border-r border-white/10">
                   <div className="w-8 h-8 rounded-full bg-red-600/10 flex items-center justify-center"><ThumbsUp className="w-4 h-4 text-red-600" /></div>
